...
the [Security
Policy](https://github.com/adbc-drivers/presto?tab=security-ov-file#readme).
...
You will also need to set up a Presto instance (see [the validation
...
Then look at `./generated/presto.md`.
