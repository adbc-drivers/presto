...
// const char* PrestoArrayStreamGetLastError(struct ArrowArrayStream*);
// void PrestoArrayStreamRelease(struct ArrowArrayStream*);
//
// int PrestoArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int PrestoArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
var drv = presto.NewDriver(alloc)
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_PrestoError, C.size_t(1))
	cErr := (*C.struct_PrestoError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.PrestoReleaseErrWithDetails)
...
func initLoggingFromEnv(db adbc.DatabaseLogging) {
	...
	case "":
		return
	default:
		fmt.Fprintf(os.Stderr, "presto: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
		return
	}
	...
	case "tempfile":
		...
		f, err := os.CreateTemp("", "adbc-presto.*.log")
		if err == nil {
			sink = f
		} else {
			fmt.Fprintf(os.Stderr, "[presto] could not open temporary log file: %v", err)
		}
	}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.PrestoerrRelease(cStream.adbcErr)
		} else {
...
//export PrestoArrayStreamGetLastError
func PrestoArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.PrestoArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export PrestoArrayStreamGetNext
func PrestoArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.PrestoArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export PrestoArrayStreamGetSchema
func PrestoArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.PrestoArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export PrestoArrayStreamRelease
func PrestoArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.PrestoArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export PrestoErrorFromArrayStream
func PrestoErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.PrestoArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.PrestoArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.PrestoArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.PrestoArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.PrestoArrayStreamRelease)
...
//export PrestoDatabaseGetOption
func PrestoDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseGetOptionBytes
func PrestoDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseGetOptionDouble
func PrestoDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseGetOptionInt
func PrestoDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseInit
func PrestoDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseNew
func PrestoDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseRelease
func PrestoDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export PrestoDatabaseSetOption
func PrestoDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseSetOptionBytes
func PrestoDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseSetOptionDouble
func PrestoDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoDatabaseSetOptionInt
func PrestoDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetOption
func PrestoConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetOptionBytes
func PrestoConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetOptionDouble
func PrestoConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetOptionInt
func PrestoConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionNew
func PrestoConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionSetOption
func PrestoConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionSetOptionBytes
func PrestoConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionSetOptionDouble
func PrestoConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionSetOptionInt
func PrestoConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionInit
func PrestoConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionRelease
func PrestoConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionCancel
func PrestoConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetInfo
func PrestoConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetObjects
func PrestoConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export PrestoConnectionGetStatistics
func PrestoConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetStatisticNames
func PrestoConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export PrestoConnectionGetTableSchema
func PrestoConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionGetTableTypes
func PrestoConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionReadPartition
func PrestoConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoConnectionCommit
func PrestoConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func PrestoConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementGetOption
func PrestoStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementGetOptionBytes
func PrestoStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementGetOptionDouble
func PrestoStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementGetOptionInt
func PrestoStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementNew
func PrestoStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementRelease
func PrestoStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func PrestoStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementPrepare
func PrestoStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func PrestoStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementExecuteSchema
func PrestoStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export PrestoStatementSetSqlQuery
func PrestoStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementSetSubstraitPlan
func PrestoStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementBind
func PrestoStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementBindStream
func PrestoStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementGetParameterSchema
func PrestoStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementSetOption
func PrestoStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementSetOptionBytes
func PrestoStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementSetOptionDouble
func PrestoStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementSetOptionInt
func PrestoStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export PrestoStatementExecutePartitions
func PrestoStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export AdbcDriverPrestoInit
func AdbcDriverPrestoInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.PrestoDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.PrestoDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.PrestoDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.PrestoDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.PrestoConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.PrestoConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.PrestoConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.PrestoConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.PrestoConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.PrestoConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.PrestoConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.PrestoConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.PrestoConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.PrestoConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.PrestoConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.PrestoStatementNew)
	driver.StatementRelease = (*[0]byte)(C.PrestoStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.PrestoStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.PrestoStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.PrestoStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.PrestoStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.PrestoStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.PrestoStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.PrestoStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.PrestoStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.PrestoStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.PrestoErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.PrestoErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.PrestoErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.PrestoDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.PrestoDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.PrestoDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.PrestoDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.PrestoDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.PrestoDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.PrestoDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.PrestoConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.PrestoConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.PrestoConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.PrestoConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.PrestoConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.PrestoConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.PrestoConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.PrestoConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.PrestoConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.PrestoConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.PrestoStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.PrestoStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.PrestoStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.PrestoStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.PrestoStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.PrestoStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.PrestoStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.PrestoStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.PrestoStatementSetOptionInt)
	}
