...
class PrestoQuirks(model.DriverQuirks):
    name = "presto"
    driver = "adbc_driver_presto"
    driver_name = "ADBC Driver Foundry Driver for Presto"
    vendor_name = "Presto"
    vendor_version = re.compile(r"Presto 0\.\d+")
    short_version = "0.295"
